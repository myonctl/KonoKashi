...
from lyricflow.application.ports import DiagnosticCheck
from lyricflow.application.storage_diagnostics import StorageStatus
...
def build_release_diagnostic_export(
    *,
    ...
    return ReleaseDiagnosticExport(
        ...
        lyricflow_version=lyricflow_version,

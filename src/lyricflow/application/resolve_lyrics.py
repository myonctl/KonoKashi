...
from lyricflow.domain.identity import PersistenceScope
...
from lyricflow.domain.lyrics_matching import CandidateMatchAssessment, assess_candidate
...
class LyricsResolver:
    ...
    def resolve(
        ...
        if offline:
            search, search_cached, _ = self._provider_result(
    ...
    def _accept_provider(
        ...
        *,
        ...
        document, document_diagnostics = self._provider_documents.build(
            assessment.candidate, self._now()
        )

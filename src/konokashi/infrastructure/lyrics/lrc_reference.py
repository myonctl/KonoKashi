"""Python reference oracle for bounded LRC/plain-text parsing."""
...
def parse_lyrics_text_python(
    text: str,
    *,
    timing_provenance: TimingProvenance | None = TimingProvenance.PROVIDER,
    duration_ms: int | None = None,
) -> ParsedLyricsText:
    """Retain the pre-native parser as an independent differential oracle."""

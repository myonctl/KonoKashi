"""PySide6 Widgets main window for the LyriFlux desktop."""
...
class DiagnosticsDialog(QDialog):
    ...
    def __init__(self, state: DesktopViewState, parent: QWidget | None = None) -> None:
        ...
        self.setWindowTitle("LyriFlux details")
        self.resize(560, 360)
        layout = QVBoxLayout(self)
        details = QPlainTextEdit()
        details.setReadOnly(True)
        details.setAccessibleName("LyriFlux diagnostic details")
        lines = [
...
class MainWindow(QMainWindow):
    ...
    def __init__(
        ...
        *,
        ...
        self.setWindowTitle("LyriFlux")
        self.setMinimumSize(420, 420)
        self.resize(760, 720)

        root = QWidget()
        root.setAccessibleName("LyriFlux main view")
    ...
    def render_state(self, state: DesktopViewState) -> None:
        ...
        self._state = state
        self.title_label.setText(state.title or "LyriFlux")

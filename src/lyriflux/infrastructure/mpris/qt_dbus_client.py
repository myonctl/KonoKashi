...
from lyriflux.infrastructure.clocks import LinuxClock
...
from lyriflux.infrastructure.mpris.metadata_mapper import MPRIS_OBJECT_PATH
from lyriflux.infrastructure.mpris.player_registry import (
    MprisClient,
    MprisMonitor,
...
def create_qt_mpris_runtime() -> QtMprisRuntime:
    ...
    if application is None:
        application = QCoreApplication(["lyriflux"])

...
This is a compact list of accepted future problems. Details and sequencing belong
...
- Add per-track display choices only after real use shows which global lyric
  layer/appearance settings need a durable recording-specific override.

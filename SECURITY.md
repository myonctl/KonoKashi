...
- impacted component and environment;
...
Sanitize unrelated data. Please allow the maintainer reasonable time to confirm,
fix, and coordinate disclosure before publishing details.
